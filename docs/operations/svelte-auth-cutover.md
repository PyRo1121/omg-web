...
| #   | Action                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Rollback                                                                                                                                                                                                                   |
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | **Bind production GitHub credentials at deploy time.** `alchemy.run.ts` already declares `GITHUB_CLIENT_ID` via `Config.string` and `GITHUB_CLIENT_SECRET` via `Config.redacted`; provision `PRODUCTION_GITHUB_CLIENT_ID` and `PRODUCTION_GITHUB_CLIENT_SECRET` in the deploy environment or the `omg-web-alchemy` keyring. The wrapper maps only those stage-specific values for `--stage prod` and refuses fallback to the shadow app. The callback stays `https://omg.latham.cloud/api/auth/callback/github`. Verify the shadow-stage plan remains a no-op and still uses its independent callback. | Remove or correct the production-specific inputs; the shadow stage remains untouched. No GitHub-side rollback is required unless the production app itself was edited.                                                     |
