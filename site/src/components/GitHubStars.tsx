...
const formatStarCount = (count: number): string => {
  if (count >= 1000) {
    ...
    return hasDecimal ? `${(count / 1000).toFixed(1)}k` : `${wholeThousands}k`;
  }
...
const StarIcon: Component = () => (
  <svg class="h-4 w-4 text-amber-400" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
...
const LoadingPulse: Component = () => <div class="h-4 w-6 animate-pulse rounded bg-slate-600" />;
