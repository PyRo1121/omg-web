  ...
  return (
    <GlassCard class={`p-8 ${props.class || ''}`}>
      <div class="mb-6 flex items-center justify-between">
        <h3 class="text-lg font-bold tracking-widest text-white uppercase">Fleet Security</h3>
        <Shield size={20} class="text-rose-500" />
      </div>

      <div class="space-y-6">
        <div>
          <div class="mb-2 flex justify-between text-[11px] font-black tracking-widest uppercase">
        ...
        <div class="grid grid-cols-2 gap-4">
          <div class="rounded-2xl border border-white/[0.03] bg-white/[0.02] p-4">
