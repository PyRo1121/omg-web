...
<main id="main-content" class="login-shell">
  <section class="login-panel" aria-labelledby="login-title">
    ...
    <h1 id="login-title" class="login-title">Pick up where you left off.</h1>
    <p class="login-copy">
    ...
    >
      <svg aria-hidden="true" viewBox="0 0 24 24" class="login-github-icon">
        <path
          fill="currentColor"
    ...
    {#if view.error}
      <p role="alert" class="login-error">{view.error}</p>
    {/if}
  </section>
</main>
